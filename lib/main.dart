...
import 'cekkoneksi/nointernet.dart';
...
Future<void> main() async {
  ...
  // Menginisialisasi dependency controller sebelum aplikasi dijalankan
    Get.put(NetworkController());// Mendaftarkan NetworkController

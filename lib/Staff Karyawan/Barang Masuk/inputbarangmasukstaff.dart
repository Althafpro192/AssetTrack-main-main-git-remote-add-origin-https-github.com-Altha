...
import 'barangmasukstaff.dart';

class InputBarangMasukStaff extends StatefulWidget {
  const InputBarangMasukStaff({super.key});

  @override
  State<InputBarangMasukStaff> createState() => _InputBarangMasukStaffState();
}

class _InputBarangMasukStaffState extends State<InputBarangMasukStaff> {
  String? selectedItem;
  ...
  void initState() {
    ...
    tanggalController.text = DateFormat('yyyy-MM-dd HH:mm a')
  ...
  void _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        // Pastikan input barangMasuk valid
        int barangMasuk;
        try {
          barangMasuk = int.parse(jumlahController.text);
        } catch (e) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            backgroundColor: Colors.red,
            content: const Text(
              'Jumlah masuk tidak valid!',
              style: TextStyle(
                fontSize: 20.0,
                fontWeight: FontWeight.bold,
                fontFamily: 'poppins',
        ...
        // Tambahkan data barang masuk ke koleksi Barang_masuk
        await FirebaseFirestore.instance.collection('Barang_masuk').add({
        ...
        await FirebaseFirestore.instance
            ...
            .doc(kategoriDoc.id)
            .update({
          'Jumlah': jumlahBarangSaatIni + barangMasuk,
        });
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          content: const Text(
            'Barang Masuk Berhasil di Tambahkan!!!',
            style: TextStyle(
              fontSize: 14.0,
              fontWeight: FontWeight.bold,
              fontFamily: 'poppins',

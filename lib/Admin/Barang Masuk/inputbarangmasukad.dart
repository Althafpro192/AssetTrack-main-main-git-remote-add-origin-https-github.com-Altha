...
import 'barangmasukad.dart';


class InputBarangMasukad extends StatefulWidget {
  const InputBarangMasukad({super.key});

  @override
  State<InputBarangMasukad> createState() => _InputBarangMasukadState();
}

class _InputBarangMasukadState extends State<InputBarangMasukad> {
  String? selectedItem;
